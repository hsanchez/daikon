...
public class CommandLineParseResult {
  ...
  void printUsage(){
    ...
    System.out.println();
    System.out.println("  --invoke-with <mode-specific-actions>: invoke a strategy for (mine|sim) modes.");
    System.out.println();
    System.out.println("      <mode-specific-actions>: <mlcs|pim> for the mine mode, ");
    System.out.println("        <km|sac> for the sim mode. Examples: ");
