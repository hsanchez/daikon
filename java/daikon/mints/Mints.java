 ...
 * setup, and mine. To run setup from the command line, run
 * <code>java daikon.mints.Mints --mode setup &lt;path/to/gz-files&gt; &lt;path/to/output.json&gt;</code>.
 * For running the mine mode with the baseline mining strategy, use
 * <code>java daikon.mints.Mints --mode mine &lt;path/to/input.json&gt; &lt;path/to/pattern.json&gt;</code>.
 *
